...
export default function Home() {
  return (
    <div className="md:m-20 mx-10 mb-10 -my-16 text-gray-400 body-font font-sarif md:grid md:grid-cols-4">
      <div className="lg:col-span-1 flex justify-center items-center col-span-4 p-12 md:p-8 ">
        <Image
          alt="profilpic"
      ...
      <div className="lg:col-span-3 col-span-4 md:ml-20 md:mt-10 md:mr-20 -my-3 text-left font-normal">
